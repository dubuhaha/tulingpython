...
class RandomBall():
    ...
    def __init__(self, canvas, scrnwidth, scrnheight):
        '''
        canvas: 画布，所有的内容动应该在画布上呈现出来，此处通过此变量传入
        ...
        # 此处xverlocity模拟x轴方向运动
        self.xvelocity = random.randint(15, 30)
        # 同理 yverlocity模拟的是y轴方向的运动
        self.yvelocity = random.randint(10, 20)
        ...
        # 定义颜色
        # RGB表示法：三个数字，每个数字值是0-255直接，表示红绿蓝三个颜色的大小
...
class ScreenSaver():
    ...
    def myquit(self, e):
        ...
        # 实际上并不关心事件的类型
        # 作业：
        # 此屏保程序扩展成，一旦捕获时间，则判断屏保不退出
        # 显示一个Button，Button上显示时间的类型，点击Button后屏保才退出
        self.root.destroy()
